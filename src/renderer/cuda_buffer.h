...
public:
    ...
    [[nodiscard]] auto get() const -> CUdeviceptr { return reinterpret_cast<CUdeviceptr>( d_ptr_ ); }

    [[nodiscard]] auto get(size_t index) const -> CUdeviceptr {
        return reinterpret_cast<CUdeviceptr>( d_ptr_ + index );
    }
    ...
    [[nodiscard]] auto reservedCount() const -> size_t { return alloc_count_; }
    [[nodiscard]] auto byteSize() const -> size_t { return alloc_count_ * sizeof(T); }
