...
SceneAssets SceneList::CubeAndSpheres(CameraInitialSate& camera)
{
	...
	textures.push_back(Texture::LoadTexture("../resources/textures/land_ocean_ice_cloud_2048.png", Vulkan::SamplerConfig()));
...
SceneAssets SceneList::LucyInOneWeekend(CameraInitialSate& camera)
{
	...
	auto lucy0 = Model::LoadModel("../resources/models/lucy.obj");
	auto lucy1 = lucy0;
	auto lucy2 = lucy0;
