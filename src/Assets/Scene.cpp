...
template<class T>
void copyFromStagingBuffer(vulkan::CommandPool &command_pool, vulkan::Buffer &dst_buffer,
...
template<class T>
void createDeviceBuffer(vulkan::CommandPool &command_pool, const VkBufferUsageFlags usage,
                        const std::vector<T> &content, std::unique_ptr<vulkan::Buffer> &buffer,
...
Scene::Scene(vulkan::CommandPool &command_pool, std::vector<Model> &&models, std::vector<Texture> &&textures,
  ...
  createDeviceBuffer(command_pool, VK_BUFFER_USAGE_VERTEX_BUFFER_BIT | flag, vertices, vertex_buffer_,
                     vertex_buffer_memory_);
  createDeviceBuffer(command_pool, VK_BUFFER_USAGE_INDEX_BUFFER_BIT | flag, indices, index_buffer_,
                     index_buffer_memory_);
  createDeviceBuffer(command_pool, VK_BUFFER_USAGE_STORAGE_BUFFER_BIT, materials, material_buffer_,
                     material_buffer_memory_);
  createDeviceBuffer(command_pool, VK_BUFFER_USAGE_STORAGE_BUFFER_BIT, offsets, offset_buffer_, offset_buffer_memory_);

  createDeviceBuffer(command_pool, VK_BUFFER_USAGE_STORAGE_BUFFER_BIT, aabbs, aabb_buffer_, aabb_buffer_memory_);
  createDeviceBuffer(command_pool, VK_BUFFER_USAGE_STORAGE_BUFFER_BIT, procedurals, procedural_buffer_,
