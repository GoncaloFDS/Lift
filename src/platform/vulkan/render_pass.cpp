...
RenderPass::RenderPass(const class SwapChain &swap_chain, const class DepthBuffer &depth_buffer,
                       const bool clear_color_buffer, const bool clear_depth_buffer) :
