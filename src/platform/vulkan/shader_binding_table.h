...
class ShaderBindingTable final {
  ...
  ShaderBindingTable(const DeviceProcedures &device_procedures, const RayTracingPipeline &ray_tracing_pipeline,
                     const RayTracingProperties &ray_tracing_properties, const std::vector<Entry> &ray_gen_programs,
