...
class RayTracingPipeline final {
  public:
  RayTracingPipeline(const DeviceProcedures &device_procedures, const SwapChain &swap_chain,
                     ...
                     const std::vector<assets::UniformBuffer> &uniform_buffers, const assets::Scene &scene);
  ~RayTracingPipeline();
