...
public:
    ...
    const std::function<VkResult(VkDevice device,
                                 const VkAccelerationStructureCreateInfoNV* p_create_info,
    ...
    const std::function<void(VkDevice device,
                             const VkAccelerationStructureMemoryRequirementsInfoNV* p_info,
    ...
    const std::function<void(VkCommandBuffer command_buffer,
                             const VkAccelerationStructureInfoNV* p_info,
    ...
    const std::function<
        VkResult(VkDevice device, VkAccelerationStructureNV acceleration_structure, size_t data_size, void* p_data)>
