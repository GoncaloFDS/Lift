...
Device::Device(VkPhysicalDevice physical_device, const class Surface& surface)
    ...
    const auto transfer_family = findQueue(queue_families, "transfer", VK_QUEUE_TRANSFER_BIT,
    ...
    vulkanCheck(vkCreateDevice(physical_device, &create_info, nullptr, &device_),
