...
DescriptorPool::DescriptorPool(const vulkan::Device &device, const std::vector<DescriptorBinding> &descriptor_bindings,
  ...
  vulkanCheck(vkCreateDescriptorPool(device.handle(), &pool_info, nullptr, &descriptor_pool_),
