	...
	isWireFrame_(isWireFrame)
{
	...
	// Load shaders.
	const ShaderModule vertShader(device, "../resources/shaders/Graphics.vert.spv");
	const ShaderModule fragShader(device, "../resources/shaders/Graphics.frag.spv");
    ...
    Vulkan_Check(vkCreateGraphicsPipelines(device.Handle(), nullptr, 1, &pipelineInfo, nullptr, &pipeline_),
